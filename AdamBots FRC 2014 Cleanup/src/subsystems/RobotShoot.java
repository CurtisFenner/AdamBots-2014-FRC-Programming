...
public abstract class RobotShoot {
	...
	//// STAGES ----------------------------------------------------------------
	// releases the latch
	public static void pauseAfterFiring() {
	...
	public static void windTooFarBack() {
	...
	public static void latchShooterAtBack() {
		closeLatch();
		stopSpeed();
		if (deltaTime() >= 0.5) {
			changeStage(60);
	...
	public static void latchedControlShooterTension() {
